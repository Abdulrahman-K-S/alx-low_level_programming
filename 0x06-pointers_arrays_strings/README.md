...
Solution: [0-strcat.c](0-strcat.c).
...
Solution: [1-strncat.c](1-strncat.c).
...
Solution: [2-strncpy.c](2-strncpy.c).
...
Solution: [3-strcmp.c](3-strcmp.c).
...
Solution: [4-rev_array.c](4-rev_array.c).
...
Solution: [5-string_toupper.c](5-string_toupper.c).
...
Solution: [6-cap_string.c](6-cap_string.c).
