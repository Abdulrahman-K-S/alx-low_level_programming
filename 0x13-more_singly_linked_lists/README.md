# <p align='center'>0x13-more_singly_linked_lists</p>
...
- [Mandatory](#mandatory).
    ...
    - [5. Free](#5-free)
    - [6. Pop](#6-pop)
    - [7. Get node at index](#7-get-node-at-index)
    - [8. Sum list](#8-sum-list)
    - [9. Insert](#9-insert)
    - [10. Delete at index](#10-delete-at-index)
- [Advanced](#advanced).
    - [11. Reverse list](#11-reverse-list)
    - [12. Print (safe version)](#12-print-safe-version)
    - [13. Free (safe version)](#13-free-safe-version)
    - [14. Find the loop](#14-find-the-loop)
