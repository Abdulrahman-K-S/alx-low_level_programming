...
Solution: [0-memset.c](0-memset.c)
...
Solution: [1-memcpy.c](1-memcpy.c)
...
Solution: [2-strchr.c](2-strchr.c)
...
Solution: [3-strspn.c](3-strspn.c)
...
Solution: [4-strpbrk.c](4-strpbrk.c)
...
Solution: [5-strstr.c](5-strstr.c)
...
Solution: [7-print_chessboard.c](7-print_chessboard.c)
...
Solution: [8-print_diagsums.c](8-print_diagsums.c)
