# <p align='center'>0x1E. C - Search Algorithms</p>
...
- [Advanced Tasks](#advanced)
    - [7. Jump search](#7-jump-search)
    - [8. Big O #5](#8-big-o-5)
    - [9. Interpolation search](#9-interpolation-search)
    - [10. Exponential search](#10-exponential-search)
    - [11. Advanced binary search](#11-advanced-binary-search)
    - [12. Jump search in a singly linked list](#12-jump-search-in-a-singly-linked-list)
    - [13. Linear search in a skip list](#13-linear-search-in-a-skip-list)
    - [14. Big O #6](#14-big-o-6)
    - [15. Big O #7](#15-big-o-7)
...
Solution: [102-interpolation.c](102-interpolation.c)
