# <p align='center'>0x04. C - More functions, more nested loops</p>
...
Solution: [0-isupper.c](0_isupper.c)
...
Solution: [1-isdigit.c](1-isdigit.c)
...
Solution: [3-print_numbers.c](3-print_numbers.c)
...
Solution: [4-print_most_numbers.c](4-print_most_numbers.c)
...
Solution: [5-more_numbers.c](5-more_numbers.c)
...
Solution: [6-print_line.c](6-print_line.c)
...
- If `n` is `0` for less, the function should only print a `\n`
...
Solution: [7-print_diagonal.c](7-print_diagonal.c)
...
Solution: [8-print_square.c](8-print_square.c)
...
Solution: [9-fizz_buzz.c](9-fizz_buzz.c)
...
Solution: [10-print_triangle.c](10-print_triangle.c)

## <p align='center>Advanced</p>

### 11. The problem of distinguishing prime numbers from composite numbers and of resolving the latter into their prime factors is known to be one of the most important and useful in arithmetic
The prime factors of `1231952` are `2`, `2`, `2`, `2`, `37` and `208`1.
...
Solution: [100-prime_factor.c](100-prime_factor.c)
